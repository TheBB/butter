...
class Upgrade:
    ...
    def get_upgrade(self, fn):
        urls = self.potential_urls(fn)
        with TemporaryDirectory() as path:
            ...
            run_gui(program=UpgradeProgram.factory(fn, *alternatives))
